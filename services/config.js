...
const defaultPath = path.resolve(os.homedir() + '/.appwatch/default.yml');
...
if(global.configFile) {
    ...
    } else if(fs.existsSync(path.resolve(os.homedir() + '/.appwatch/' + global.configFile))) {
        configFilePath = path.resolve(os.homedir() + '/.appwatch/' + global.configFile);
    } else {
