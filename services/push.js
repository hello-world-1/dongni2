...
const pushService=  (registration_id,content) => {
    console.log("registration_id:" + registration_id + "||content:" + content)
    client.push()
        ...
        .setAudience(JPush.registration_id(registration_id)) //设置推送目标,别名、标签、注册ID、分群、广播等方式
